...
"""Minimal Django settings for evennia-calendar unit tests.
...
LOG_DIR = os.path.join(tempfile.gettempdir(), "evennia_calendar_test_logs")
...
# One database. The library owns no tables — the calendar is derived from
# game time, so there is nothing to store.
DATABASES = {
    "default": {
        "ENGINE": "django.db.backends.sqlite3",
        "NAME": ":memory:",
        "TEST": {"NAME": "file:evennia_calendar_test_default?mode=memory&cache=shared"},
    },
}
