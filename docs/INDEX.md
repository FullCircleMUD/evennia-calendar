...
The library is early, so this list is short. It grows as the extraction is designed and decisions are
recorded.
...
No design document yet. The shape being built toward is recorded as principles in
